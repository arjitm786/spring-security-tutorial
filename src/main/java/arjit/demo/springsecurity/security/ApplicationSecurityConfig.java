...
import arjit.demo.springsecurity.auth.ApplicationUserService;
import arjit.demo.springsecurity.jwt.JwtConfig;
import arjit.demo.springsecurity.jwt.JwtTokenVerifier;
import arjit.demo.springsecurity.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
//                .and()
//                .rememberMe().tokenValiditySeconds((int) TimeUnit.DAYS.toSeconds(21))//default 2 weeks
//                    .rememberMeParameter("remember-me")
//                    .key("somethingHardcore")
//                .and()
//                .logout()
//                    .logoutUrl("/logout")
